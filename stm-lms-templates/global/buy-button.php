...
<div class="stm-lms-buy-buttons">
	<?php if ($has_course or empty($course_price)): ?>
		...
		<?php else:
            ...
            <a href="<?php echo esc_url($lesson_url); ?>" class="btn btn-default">
                <span><?php esc_html_e('Start course by Jason', 'masterstudy-lms-learning-management-system'); ?></span>
            </a>
	...
	<?php else:
        ...
        <a href="#" <?php echo implode(' ', $attributes); ?> class="<?php echo esc_attr(implode(' ', $btn_class)); ?>">
            <span>
